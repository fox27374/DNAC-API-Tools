...
if __name__ == "__main__":
    ...
    # Print header
    print("{0:32}{1:17}{2:16}{3:18}{4:12}{5:16}{6:15}".format("Hostname", "IP Address", "Serial", "Platform", "SW Version", "Role", "Uptime"))
    ...
    for device in filtered_list:
        ...
        for (serialNumber,platformId) in serialPlatformList:
            print("{0:32}{1:17}{2:16}{3:18}{4:12}{5:16}{6:15}".format(device['hostname'], device['managementIpAddress'], serialNumber, platformId, device['softwareVersion'], device['role'], uptime))
